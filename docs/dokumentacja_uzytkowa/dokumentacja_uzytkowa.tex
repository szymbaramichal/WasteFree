...
\begin{figure}[H]
\centering
\fbox{\parbox{0.9\linewidth}{\vspace{2.2cm}\centering\textit{Miejsce na zrzut ekranu: Dashboard (Portal --- widok startowy)}\vspace{2.2cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.9\linewidth}{\vspace{2.2cm}\centering\textit{Miejsce na zrzut ekranu: Formularz rejestracji}\vspace{2.2cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.9\linewidth}{\vspace{2.2cm}\centering\textit{Miejsce na zrzut ekranu: Widok aktywacji konta (potwierdzenie)}\vspace{2.2cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.9\linewidth}{\vspace{2.2cm}\centering\textit{Miejsce na zrzut ekranu: Formularz logowania/rejestracji}\vspace{2.2cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.9\linewidth}{\vspace{2.2cm}\centering\textit{Miejsce na zrzut ekranu: Widok profilu (podgląd)}\vspace{2.2cm}}}
\captionT{Podgląd profilu użytkownika}
\end{figure}

\begin{figure}[H]
\centering
\fbox{\parbox{0.9\linewidth}{\vspace{2.2cm}\centering\textit{Miejsce na zrzut ekranu: Edycja profilu (formularz)}\vspace{2.2cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.9\linewidth}{\vspace{2.2cm}\centering\textit{Miejsce na zrzut ekranu: Sekcja adresu i wyboru miasta}\vspace{2.2cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.9\linewidth}{\vspace{2.2cm}\centering\textit{Miejsce na zrzut ekranu: Upload avatara}\vspace{2.2cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.9\linewidth}{\vspace{2.2cm}\centering\textit{Miejsce na zrzut ekranu: Portfel --- saldo użytkownika}\vspace{2.2cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.9\linewidth}{\vspace{2.2cm}\centering\textit{Miejsce na zrzut ekranu: Portfel --- dostępne metody (BLIK, IBAN)}\vspace{2.2cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.9\linewidth}{\vspace{2.2cm}\centering\textit{Miejsce na zrzut ekranu: Portfel --- formularz wpłaty (BLIK)}\vspace{2.2cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.9\linewidth}{\vspace{2.2cm}\centering\textit{Miejsce na zrzut ekranu: Portfel --- formularz wypłaty (IBAN)}\vspace{2.2cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.9\linewidth}{\vspace{2.2cm}\centering\textit{Miejsce na zrzut ekranu: Lista grup (Portal \textrightarrow{} Grupy)}\vspace{2.2cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.9\linewidth}{\vspace{2.2cm}\centering\textit{Miejsce na zrzut ekranu: Formularz utworzenia grupy (Grupy \textrightarrow{} Zarządzanie)}\vspace{2.2cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.9\linewidth}{\vspace{2.2cm}\centering\textit{Miejsce na zrzut ekranu: Szczegóły grupy (opis, adres, członkowie)}\vspace{2.2cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.9\linewidth}{\vspace{2.2cm}\centering\textit{Miejsce na zrzut ekranu: Edycja danych grupy (tryb edycji)}\vspace{2.2cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.9\linewidth}{\vspace{2.2cm}\centering\textit{Miejsce na zrzut ekranu: Zapraszanie do grupy (pole nazwy użytkownika)}\vspace{2.2cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.9\linewidth}{\vspace{2.2cm}\centering\textit{Miejsce na zrzut ekranu: Lista zaproszeń oczekujących (Akceptuj/Odrzuć)}\vspace{2.2cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.9\linewidth}{\vspace{2.2cm}\centering\textit{Miejsce na zrzut ekranu: Lista członków grupy z akcją usunięcia}\vspace{2.2cm}}}
...
Komunikacja jest realizowana dwutorowo:
\begin{itemize}
\item \textbf{historia wiadomości} jest pobierana z systemu w postaci zapytań do API (paginacja),
\item \textbf{nowe wiadomości} mogą być dostarczane w czasie rzeczywistym poprzez połączenie \textbf{SignalR} (hub \texttt{/chatHub}).
\end{itemize}

\begin{figure}[H]
\centering
\fbox{\parbox{0.9\linewidth}{\vspace{2.2cm}\centering\textit{Miejsce na zrzut ekranu: Panel grupy \textrightarrow{} zakładka Czat}\vspace{2.2cm}}}
\captionT{Zakładka czatu w panelu grupy}
\end{figure}

\subsubsection{Historia wiadomości}
Po otwarciu zakładki czatu aplikacja pobiera ostatnie wiadomości dla wybranej grupy. Historia jest dostępna stronicowana (paginacja) i w interfejsie użytkownik może załadować starsze wiadomości przyciskiem \textit{Wczytaj starsze}.
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.9\linewidth}{\vspace{2.2cm}\centering\textit{Miejsce na zrzut ekranu: Historia czatu (lista wiadomości + wczytaj starsze)}\vspace{2.2cm}}}
\captionT{Historia wiadomości w czacie grupy}
\end{figure}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.9\linewidth}{\vspace{2.2cm}\centering\textit{Miejsce na zrzut ekranu: Pole wpisywania wiadomości + walidacja + status połączenia}\vspace{2.2cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.9\linewidth}{\vspace{2.2cm}\centering\textit{Miejsce na zrzut ekranu: Zamów wywóz --- kreator (krok 1: rodzaj wywozu)}\vspace{2.2cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.9\linewidth}{\vspace{2.2cm}\centering\textit{Miejsce na zrzut ekranu: Zamów wywóz --- kreator (krok 2: grupa i uczestnicy)}\vspace{2.2cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.9\linewidth}{\vspace{2.2cm}\centering\textit{Miejsce na zrzut ekranu: Zamów wywóz --- kreator (krok 3: adres i harmonogram)}\vspace{2.2cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.9\linewidth}{\vspace{2.2cm}\centering\textit{Miejsce na zrzut ekranu: Zamów wywóz --- kreator (krok 4: szczegóły)}\vspace{2.2cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.9\linewidth}{\vspace{2.2cm}\centering\textit{Miejsce na zrzut ekranu: Zamów wywóz --- kreator (krok 5: podsumowanie)}\vspace{2.2cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.9\linewidth}{\vspace{2.2cm}\centering\textit{Miejsce na zrzut ekranu: Podsumowanie zamówienia + panel kalkulacji kosztu}\vspace{2.2cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.9\linewidth}{\vspace{2.2cm}\centering\textit{Miejsce na zrzut ekranu: Szczegóły zamówienia --- sekcja płatności (WaitingForPayment)}\vspace{2.2cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.9\linewidth}{\vspace{2.2cm}\centering\textit{Miejsce na zrzut ekranu: Moje odbiory --- lista zamówień + filtry + paginacja}\vspace{2.2cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.9\linewidth}{\vspace{2.2cm}\centering\textit{Miejsce na zrzut ekranu: Szczegóły zamówienia --- podsumowanie + tabela uczestników}\vspace{2.2cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.9\linewidth}{\vspace{2.2cm}\centering\textit{Miejsce na zrzut ekranu: Szczegóły zamówienia --- opłata utylizacyjna (WaitingForUtilizationFee)}\vspace{2.2cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.9\linewidth}{\vspace{2.2cm}\centering\textit{Miejsce na zrzut ekranu: Topbar --- ikona skrzynki odbiorczej z licznikiem wiadomości}\vspace{2.2cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.9\linewidth}{\vspace{2.2cm}\centering\textit{Miejsce na zrzut ekranu: Inbox --- lista wiadomości + sterowanie paginacją i rozmiarem strony}\vspace{2.2cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.9\linewidth}{\vspace{2.2cm}\centering\textit{Miejsce na zrzut ekranu: Inbox --- wiadomość z przyciskami Akceptuj/Odrzuć oraz Otwórz}\vspace{2.2cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.9\linewidth}{\vspace{2.2cm}\centering\textit{Miejsce na zrzut ekranu: Inbox --- usuwanie pojedynczej wiadomości (przycisk X)}\vspace{2.2cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.9\linewidth}{\vspace{2.2cm}\centering\textit{Miejsce na zrzut ekranu: Inbox --- przycisk Wyczyść wszystko (czyszczenie skrzynki)}\vspace{2.2cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.9\linewidth}{\vspace{2.2cm}\centering\textit{Miejsce na zrzut ekranu: Modal zgody Garbage Admin (treść zgody)}\vspace{2.2cm}}}
\captionT{Zgoda Administratora odpadów: prezentacja treści}
\end{figure}

\begin{figure}[H]
\centering
\fbox{\parbox{0.9\linewidth}{\vspace{2.2cm}\centering\textit{Miejsce na zrzut ekranu: Modal zgody (przyciski Akceptuj/Odrzuć)}\vspace{2.2cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.9\linewidth}{\vspace{2.2cm}\centering\textit{Miejsce na zrzut ekranu: Zlecenia oczekujące (waiting) --- lista kart + paginacja + Odśwież}\vspace{2.2cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.9\linewidth}{\vspace{2.2cm}\centering\textit{Miejsce na zrzut ekranu: Zlecenie oczekujące --- przycisk Akceptuj (stan ładowania)}\vspace{2.2cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.9\linewidth}{\vspace{2.2cm}\centering\textit{Miejsce na zrzut ekranu: Zlecenia przypisane (assigned/current) --- akcje Czat/Zgłoś opłatę}\vspace{2.2cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.9\linewidth}{\vspace{2.2cm}\centering\textit{Miejsce na zrzut ekranu: Modal zgłoszenia opłaty utylizacyjnej (kwota + wybór pliku)}\vspace{2.2cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.9\linewidth}{\vspace{2.2cm}\centering\textit{Miejsce na zrzut ekranu: Rejestracja --- krok 1 (dane + wybór roli)}\vspace{2.2cm}}}
\captionT{Scenariusz: rejestracja konta (krok 1)}
\end{figure}

\begin{figure}[H]
\centering
\fbox{\parbox{0.9\linewidth}{\vspace{2.2cm}\centering\textit{Miejsce na zrzut ekranu: Aktywacja konta (widok /activate-account/TOKEN)}\vspace{2.2cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.9\linewidth}{\vspace{2.2cm}\centering\textit{Miejsce na zrzut ekranu: Tworzenie grupy (Grupy \textrightarrow{} Zarządzanie)}\vspace{2.2cm}}}
\captionT{Scenariusz: utworzenie grupy odpadów}
\end{figure}

\begin{figure}[H]
\centering
\fbox{\parbox{0.9\linewidth}{\vspace{2.2cm}\centering\textit{Miejsce na zrzut ekranu: Panel grupy --- sekcja zaproszeń (pole nazwy użytkownika)}\vspace{2.2cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.9\linewidth}{\vspace{2.2cm}\centering\textit{Miejsce na zrzut ekranu: Kreator zamówienia --- krok podsumowania (szacunkowy koszt)}\vspace{2.2cm}}}
\captionT{Scenariusz: podsumowanie zamówienia i szacunkowy koszt}
\end{figure}

\begin{figure}[H]
\centering
\fbox{\parbox{0.9\linewidth}{\vspace{2.2cm}\centering\textit{Miejsce na zrzut ekranu: Szczegóły zamówienia (WaitingForPayment) + przycisk płatności udziału}\vspace{2.2cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.9\linewidth}{\vspace{2.2cm}\centering\textit{Miejsce na zrzut ekranu: Panel grupy --- zakładka Czat (historia + pole wiadomości + status połączenia)}\vspace{2.2cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.9\linewidth}{\vspace{2.2cm}\centering\textit{Miejsce na zrzut ekranu: Inbox --- zaproszenie do grupy (Akceptuj/Odrzuć)}\vspace{2.2cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.9\linewidth}{\vspace{2.2cm}\centering\textit{Miejsce na zrzut ekranu: Modal zgody Garbage Admin (treść + Akceptuj/Odrzuć)}\vspace{2.2cm}}}
\captionT{Scenariusz Garbage Admin: akceptacja zgody}
\end{figure}

\begin{figure}[H]
\centering
\fbox{\parbox{0.9\linewidth}{\vspace{2.2cm}\centering\textit{Miejsce na zrzut ekranu: Zlecenia oczekujące (waiting) + akcja Akceptuj}\vspace{2.2cm}}}
\captionT{Scenariusz Garbage Admin: akceptacja zlecenia}
\end{figure}

\begin{figure}[H]
\centering
\fbox{\parbox{0.9\linewidth}{\vspace{2.2cm}\centering\textit{Miejsce na zrzut ekranu: Zlecenia przypisane/aktywne (assigned/current) + modal zgłoszenia opłaty utylizacyjnej}\vspace{2.2cm}}}
